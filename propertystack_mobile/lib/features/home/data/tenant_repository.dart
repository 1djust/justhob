...
class TenantRepository {
  ...
  Future<List<MaintenanceRequest>> getManagerMaintenanceRequests(String workspaceId) async {
    final response = await _apiClient.dio.get('/workspaces/$workspaceId/maintenance');
    final List data = response.data['requests'];
    return data.map((json) => MaintenanceRequest.fromJson(json)).toList();
  }
  ...
  Future<void> updateMaintenanceStatus({
    ...
    await _apiClient.dio.put(
      '/workspaces/$workspaceId/maintenance/$requestId',
      data: {
