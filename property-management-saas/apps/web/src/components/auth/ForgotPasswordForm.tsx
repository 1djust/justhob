    ...
    return (
      <div className="text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
        <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 p-8 rounded-3xl flex flex-col items-center">
          ...
          <p className="text-xl font-black text-emerald-900 dark:text-emerald-400 mb-2">Check your email</p>
          <p className="text-sm font-medium text-emerald-700 dark:text-emerald-500/80 max-w-[280px] mx-auto">
            We've sent a password reset link to <span className="font-bold text-emerald-900 dark:text-emerald-300">{email}</span>.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-black tracking-tight text-zinc-900 dark:text-white">Reset password</h1>
