  ...
  const slides = [
    {
      title: "Property\nManager.",
      description:
        "A comprehensive operating system for modern real estate professionals. Streamline operations, manage leases, and scale your property portfolio with unparalleled efficiency.",
    },
    {
      title: "Tenant\nExperience.",
      description:
        "Empowering tenants with a seamless portal for instant payments, simple maintenance requests, and direct community communication.",
    },
    {
      title: "Financial\nClarity.",
      description:
        "Automated billing, transparent reporting, and streamlined financial tracking designed to optimize modern property portfolios.",
    },
  ];
        ...
        <div className="absolute bottom-12 right-12 hidden lg:flex flex-col gap-6 pointer-events-none animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl shadow-[0_8px_32px_rgba(0,102,255,0.15)] w-72 transform translate-x-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-primary text-xs font-bold bg-primary/20 px-2 py-1 rounded-md">
                +14%
              </div>
            </div>
            {/* Mini Chart */}
