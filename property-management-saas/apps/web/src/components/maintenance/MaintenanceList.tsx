  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center gap-6 mb-6">
        ...
        <div className="flex items-center gap-2 text-sm">
          <span className="font-semibold text-zinc-700 dark:text-zinc-300">Location:</span>
          <select 
        ...
        <div className="flex items-center gap-2 ml-4 border-l border-zinc-200 dark:border-zinc-800 pl-4">
           <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 h-8 w-8">
                ...
                <tr>
                  <th className="px-6 py-4 w-12">
                    <input 
                      ...
                      checked={selectedTickets.size > 0 && selectedTickets.size === filteredRequests.length}
                ...
                {filteredRequests.map((req) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-medium text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
                       ...
                       {req.description.length > 25 ? req.description.substring(0, 25) + "..." : req.description}
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span className={`text-xs font-semibold ${
                        ...
                        {req.priority ? req.priority.charAt(0).toUpperCase() + req.priority.slice(1).toLowerCase() : "Medium"}
                      </span>
                    </td>
                    <td className="px-6 py-4">
