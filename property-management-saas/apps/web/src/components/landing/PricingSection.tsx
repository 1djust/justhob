          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-8">
                To activate the Pro or Enterprise plan, please make a bank
                transfer to the account below. Your account will automatically
                be upgraded once payment is confirmed.
              </p>
