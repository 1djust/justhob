...
const slides: CarouselSlide[] = [
  {
    src: "/images/assets/manager-dashboard.png",
    alt: "Property Manager Dashboard Overview",
    label: "Dashboard Overview",
  },
  {
    src: "/images/assets/manager-tenants.png",
    alt: "Tenant Management Table",
    label: "Tenant Management",
  },
  {
    src: "/images/assets/manager-payments.png",
    alt: "Rent Payment Tracking",
    label: "Payment Tracking",
  },
  {
    src: "/images/assets/manager-maintenance.png",
...
export function DashboardCarousel(): React.ReactElement {
  ...
  return (
    ...
    >
      {/* Cards container */}
      <div
        className="relative h-[320px] sm:h-[360px] md:h-[400px]"
