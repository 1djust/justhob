...
async function setup() {
  ...
  try {
    ...
    console.log(
      `Victim Setup: Workspace=${victimWorkspace.id}, Tenant=${victimTenant.id}, Payment=${victimPayment.id}`,
    );
    ...
    console.log(
      `Attacker Setup: Workspace=${attackerWorkspace.id}, PM_User=${aAuth.user.id}, Tenant_User=${tAuth.user.id}`,
    );
