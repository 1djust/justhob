...
async function run() {
  console.log(
    "--- Verifying Privilege Escalation: Tenant Creating Property ---",
  );
  ...
  if (response.status === 201) {
    console.log(
      "✅ VULNERABILITY CONFIRMED: Tenant successfully created a property!",
    );
    ...
    console.log(
      "❌ VULNERABILITY NOT EXPLOITED: Server correctly returned 403 Forbidden.",
    );
    console.log("Response:", JSON.stringify(result, null, 2));
  } else {
