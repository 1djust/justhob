...
process.env.DATABASE_URL =
  "postgresql://postgres.gushvedprjygyauwzvnf:1%40ActionSupabase@aws-1-eu-north-1.pooler.supabase.com:6543/postgres?pgbouncer=true";
...
async function test() {
  ...
  if (unreadCount > 0) {
    ...
    const unreadCountAfter = notifsAfterResp
      .json()
