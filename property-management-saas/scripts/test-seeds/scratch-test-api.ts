...
async function main() {
  ...
  const token = loginData.session?.access_token || loginData.token || loginData.access_token;
  ...
  console.log("Response tenant allowPartialPayments:", data.tenant?.allowPartialPayments);
