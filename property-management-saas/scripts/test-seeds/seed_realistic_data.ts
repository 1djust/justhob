...
async function seed() {
  ...
  for (const m of members) {
    await prisma.workspaceMember.upsert({
      where: {
        userId_workspaceId: { userId: m.userId, workspaceId: workspace.id },
      },
      update: { role: m.role },
  ...
  const properties = [
    {
      id: "prop-lekki-phase1",
      name: "Lekki Gardens Estate - Block A",
    ...
    {
      id: "prop-vi-office",
      name: "Adeola Odeku Office Tower",
    ...
    {
      id: "prop-ikoyi-villa",
      name: "Bourdillon Court Residences",
    ...
    {
      id: "prop-ajah-estate",
      name: "Abraham Adesanya Palm View",
      address: "22 Abraham Adesanya Estate, Ajah, Lagos",
      type: "Residential",
      units: 32,
      ownerId: owner2.id,
    },
    {
      id: "prop-surulere-plaza",
      name: "Surulere Business Plaza",
    ...
    {
      id: "prop-oniru-unassigned",
      name: "Oniru Private Estate - Phase 2",
      address: "1 Palace Road, Oniru, Victoria Island, Lagos",
      type: "Residential",
      units: 12,
      ownerId: null,
    },
  ...
  console.log(
    "🏠 7 properties created (3 for Chioma, 3 for Musa, 1 unassigned)",
  );
  ...
  const leases = [
    ...
    {
      id: "lease-005",
      tenantId: "ten-ibrahim",
      propertyId: "prop-ajah-estate",
    ...
    },
    {
      id: "lease-006",
      tenantId: "ten-aisha",
      propertyId: "prop-surulere-plaza",
  ...
  const payments = [
    ...
    },
    {
      ...
      paidDate: new Date("2026-03-04"),
      status: "PAID" as const,
      note: "March 2026 rent",
    },
    {
      id: "pay-007",
      leaseId: "lease-001",
    ...
    },
    {
      ...
      dueDate: new Date("2026-02-01"),
      status: "OVERDUE" as const,
      note: "February 2026 rent - OVERDUE",
    },
    {
      id: "pay-019",
      leaseId: "lease-005",
  ...
  const maintenanceRequests = [
    {
      id: "maint-001",
      description:
        "Water leaking from ceiling in Unit 4B bathroom. The leak appears to be coming from the flat above. Getting worse during rainfall.",
      status: "PENDING" as const,
      tenantId: "ten-emeka",
      propertyId: "prop-lekki-phase1",
    ...
    },
    {
      id: "maint-002",
      description:
        "Air conditioning unit in the reception area has stopped working completely. Temperature is unbearable for office staff and visitors.",
    ...
    },
    {
      id: "maint-003",
      description:
        "Security gate motor is faulty and the gate cannot close properly at night. This is a serious security concern.",
      status: "PENDING" as const,
      tenantId: "ten-ngozi",
      propertyId: "prop-ikoyi-villa",
      workspaceId: workspace.id,
    },
    {
      id: "maint-004",
      description:
        "Broken window pane in the master bedroom due to recent storm. Need urgent replacement for safety.",
    ...
    },
    {
      id: "maint-005",
      description:
        "Generator servicing overdue. The backup generator has not been serviced in 6 months and is making unusual noise.",
      status: "IN_PROGRESS" as const,
      tenantId: "ten-ibrahim",
      propertyId: "prop-ajah-estate",
      workspaceId: workspace.id,
    },
    {
      id: "maint-006",
      description:
        "Parking lot lights are not working on the 2nd floor. Multiple bulbs need replacement. Tenants feel unsafe parking at night.",
      status: "PENDING" as const,
      tenantId: "ten-aisha",
      propertyId: "prop-surulere-plaza",
      workspaceId: workspace.id,
    },
    {
      id: "maint-007",
      description:
        "Elevator stuck between floors twice this week. Needs professional inspection and maintenance urgently.",
      status: "PENDING" as const,
      tenantId: "ten-tunde",
      propertyId: "prop-vi-office",
      workspaceId: workspace.id,
  ...
  console.log(
    "🔧 7 maintenance requests created (4 pending, 2 in progress, 1 completed)",
  );
